...
def main():
   ...
   # Am Spektrum
    ...
    print("\nAuflösevermögen Spektrometer\n")
    print("Bei K-Linie: delta E = {:.4f} keV @ E = {:.4f} keV".format(lin(2*np.sqrt(2*np.log(2))*opt_fit_parameters1[6],popt_Kall[0],popt_Kall[1]),lin(opt_fit_parameters1[4],popt_Kall[0],popt_Kall[1])))
    print("Bei L-Linie: delta E = {:.4f} keV @ E ={:.4f} keV".format(lin(2*np.sqrt(2*np.log(2))*opt_fit_parameters1[7],popt_Kall[0],popt_Kall[1]),lin(opt_fit_parameters1[5],popt_Kall[0],popt_Kall[1])))
