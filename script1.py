...
def main():
   ...
   #Cs Beta Spektrum
    ...
    plt.plot(lin(dataSet_kr_Alu3['channel'],popt_Kall[0],popt_Kall[1])[fit_plot_range_kr_alu3[0]:fit_plot_range_kr_alu3[1]], func(lin(dataSet_kr_Alu3['channel'],popt_Kall[0],popt_Kall[1])[fit_plot_range_cs_alu3[0]:fit_plot_range_cs_alu3[1]],*opt_fit_parameters_cs_alu3), 'g--')
    plt.plot(lin(dataSet_kr_Alu6['channel'],popt_Kall[0],popt_Kall[1])[fit_plot_range_kr_alu6[0]:fit_plot_range_kr_alu6[1]], func(lin(dataSet_kr_Alu6['channel'],popt_Kall[0],popt_Kall[1])[fit_plot_range_cs_alu6[0]:fit_plot_range_cs_alu6[1]],*opt_fit_parameters_cs_alu6), 'b--')
    plt.plot(lin(dataSet_kr_Alu9['channel'],popt_Kall[0],popt_Kall[1])[fit_plot_range_kr_alu9[0]:fit_plot_range_kr_alu9[1]], func(lin(dataSet_kr_Alu9['channel'],popt_Kall[0],popt_Kall[1])[fit_plot_range_cs_alu9[0]:fit_plot_range_cs_alu9[1]],*opt_fit_parameters_cs_alu9), 'y--')
    plt.plot(lin(dataSet_kr_Alu12['channel'],popt_Kall[0],popt_Kall[1])[fit_plot_range_kr_alu12[0]:fit_plot_range_kr_alu12[1]], func(lin(dataSet_kr_Alu12['channel'],popt_Kall[0],popt_Kall[1])[fit_plot_range_cs_alu12[0]:fit_plot_range_cs_alu12[1]],*opt_fit_parameters_cs_alu12), 'm--')
    plt.xlabel(r"Energie / keV")
    plt.ylabel(r"Counts")
    plt.legend()
    plt.xlim(plot_range[0], plot_range[1])
